...
public interface IExecutiveDocumentFacade {
    ...
    ExtendedExtDoc getNextExecutiveDocumentFromCursor(ResultSet cursor) throws Exception;

    ResultSet getCursorWithExecutiveDocumentsForRegistry(BigDecimal registryId) throws Exception;
